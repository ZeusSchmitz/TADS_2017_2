...
public class ProvaEder {
    ...
    public static void main(String[] args) {
        ...
        } else if (nascimento.getYear() == datAtu.getYear() && nascimento.getMonth() > datAtu.getMonth()) {
            System.out.println("O mês é futuro");
        } else if (nascimento.getYear() == datAtu.getYear() && nascimento.getMonth() == datAtu.getMonth() && nascimento.getDate() > datAtu.getDate()) {
            System.out.println("O dia é futuro");
        }else if(nascimento.getDate() == datAtu.getDate() && nascimento.getMonth() == datAtu.getMonth()){
            System.out.println("Parabéns! Hoje é seu " + (datAtu.getYear() - nascimento.getYear()) + "º aniversário.");
        }else if(nascimento.getMonth() > datAtu.getMonth()){
            System.out.println("Pessoa com " + (datAtu.getYear() - nascimento.getYear() - 1) + " anos.");
        }else if (nascimento.getMonth() == datAtu.getMonth() && nascimento.getDate() > datAtu.getDate()){
            System.out.println("Pessoa com " + (datAtu.getYear() - nascimento.getYear()-1) + " anos.");
        }else if (nascimento.getMonth() <= datAtu.getMonth() && nascimento.getDate() < datAtu.getMonth())
